...
![UI страницы](https://via.placeholder.com/600x400?text=Пример+UI+страницы)

* Кнопка «Показать время» по центру
* Модальное окно отображает текущее время
* Контейнер Bootstrap для колонок
